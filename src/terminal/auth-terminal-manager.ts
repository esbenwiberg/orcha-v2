...
// Re-export pure functions from auth-url.ts (separated to avoid node-pty dep in tests).
export { stripAnsi, extractAuthUrl } from './auth-url.js';
import { stripAnsi } from './auth-url.js';
